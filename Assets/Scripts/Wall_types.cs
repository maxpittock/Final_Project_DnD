...
public static class Wall_types
{

    //These hashsets provide the binary values that will be used to identify which wall type is needed for that current wall posistion


    public static HashSet<int> wallTop = new HashSet<int>
    {
        //0B At the start makes it a binary value
        0b1111,
        0b0110,
        0b0011,
        0b0010,
