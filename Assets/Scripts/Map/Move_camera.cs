...
public class Move_camera : MonoBehaviour
{
    ...
    public Vector2 View_LimitX;
    public Vector2 View_LimitY;
    ...
    void Update()
    {
        ...
        //limits the camer movement with a min and max - uses a range 
        pos.x = Mathf.Clamp(pos.x, View_LimitX.x, View_LimitX.y);
        pos.y = Mathf.Clamp(pos.y, View_LimitY.x, View_LimitY.y);
